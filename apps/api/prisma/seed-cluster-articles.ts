    ...
    const articles = [
        {
            ...
            summary:
                'Ethereum declined during a broader crypto market pullback.',
            content:
        ...
        },
        {
            ...
            summary:
                'Market analysts reviewed the drivers behind the latest Ethereum correction.',
            content:
        ...
        },
        {
            ...
            summary:
                'A number of traders believe the recent decline may be temporary.',
            content:
